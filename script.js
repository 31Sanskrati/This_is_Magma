//locomotion effect using locomotive js and gsap
function loco() {
...
//text effect of page 2
var clutter = ""
document.querySelector("#page2>h1").textContent.split(" ").forEach(function (details) {
...
//text effect of page 4
var clutter = ""
document.querySelector("#page4>h1").textContent.split(" ").forEach(function (details) {
    clutter += `<span> ${details} </span>`
...
//text effect of page 6
var clutter = ""
document.querySelector("#page6>h1").textContent.split(" ").forEach(function (details) {
    clutter += `<span> ${details} </span>`
